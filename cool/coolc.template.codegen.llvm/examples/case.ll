...
;;rezerv %VR2 pentru rezultatul case-ului
  ...
  br i1 %VR7, label %case_0_noAlternativeMain_0, label %next0_case_0_noAlternativeMain_0
;#######################################; <- case_not_void_Main_0
...
next0_case_0_noAlternativeMain_0:
  ...
  br i1 %VR8, label %case_0_noAlternativeMain_0, label %next1_case_0_noAlternativeMain_0
;#######################################; <- next0_case_0_noAlternativeMain_0
...
next1_case_0_noAlternativeMain_0:
  ...
  br i1 %VR9, label %case_0_noAlternativeMain_0, label %next2_case_0_noAlternativeMain_0
;#######################################; <- next1_case_0_noAlternativeMain_0
...
next2_case_0_noAlternativeMain_0:
  ...
  br i1 %VR10, label %case_String__Main_0, label %next3_case_String__Main_0
;#######################################; <- next2_case_0_noAlternativeMain_0


;#######################################; -> next3_case_String__Main_0
next3_case_String__Main_0:
  %VR11 = icmp eq i32 %VR6,  4
  br i1 %VR11, label %case_0_noAlternativeMain_0, label %next4_case_0_noAlternativeMain_0
;#######################################; <- next3_case_String__Main_0
...
next4_case_0_noAlternativeMain_0:
  ...
  br i1 %VR12, label %case_0_noAlternativeMain_0, label %next5_case_0_noAlternativeMain_0
;#######################################; <- next4_case_0_noAlternativeMain_0


;#######################################; -> next5_case_0_noAlternativeMain_0
next5_case_0_noAlternativeMain_0:
  br label %case_String__Main_0
;#######################################; <- next5_case_0_noAlternativeMain_0
...
case_String__Main_0:
  ...
  %VR14 = add i32 3, 0
  %VR15 = ptrtoint %struct.String_protObj_t* @String_protObj to i32 
  %VR16 = add i32 %VR15, 8
...
dispatch_not_void_Main_0:
  ...
  %VR41 = call i32 (i32)* %VR40(i32 %VR3)
;; <- dispatch: linia 4
...
;#######################################; -> sfarsit_case_Main_0
sfarsit_case_Main_0:
  %VR2 = phi i32 [ %VR2.0, %phi_0_sfarsit_case_Main_0]
;; <- typcase: linia 4
  ret i32 %VR2
;#######################################; <- sfarsit_case_Main_0
...
@str_const__10 = global %struct.String_protObj_t{i32 3, i32 6, %struct.String_dispTab_t* @String_dispTab, %struct.Int_protObj_t* @int_const__0, i8* getelementptr ([5 x i8]* @s10, i32 0, i32 0)}
...
@str_const__7 = global %struct.String_protObj_t{i32 3, i32 6, %struct.String_dispTab_t* @String_dispTab, %struct.Int_protObj_t* @int_const__0, i8* getelementptr ([5 x i8]* @s7, i32 0, i32 0)}
...
@s0 = internal constant [23 x i8] c"_tests/library/case.cl\00"
@str_const__0 = global %struct.String_protObj_t{i32 3, i32 10, %struct.String_dispTab_t* @String_dispTab, %struct.Int_protObj_t* @int_const__8, i8* getelementptr ([23 x i8]* @s0, i32 0, i32 0)}
