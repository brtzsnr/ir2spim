 ...
 */
class program_ extends Program {
     ...
     */
    public program_(int lineNumber, Classes a1) {
        super(lineNumber);
        classes = a1;
    }

    public TreeNode copy() {
        return new program_(lineNumber, (Classes) classes.copy());
    }
     ...
     */
    public void cgen() {
        CgenClassTable codegen_classtable = new CgenClassTable(classes);
    }
...
class class__ extends Class_ {
     ...
     */
    public class__(int lineNumber, AbstractSymbol a1, AbstractSymbol a2, Features a3, AbstractSymbol a4) {
        super(lineNumber);
        name = a1;
        parent = a2;
        features = a3;
    ...
    public TreeNode copy() {
        return new class__(lineNumber, copy_AbstractSymbol(name), copy_AbstractSymbol(parent), (Features) features.copy(), copy_AbstractSymbol(filename));
    }
...
class formal_ extends Formal {
     ...
     * @param a1         initial value for type_decl
     */
    public formal_(int lineNumber, AbstractSymbol a1, AbstractSymbol a2) {
        super(lineNumber);
        name = a1;
        type_decl = a2;
    }
    ...
    public TreeNode copy() {
        return new formal_(lineNumber, copy_AbstractSymbol(name), copy_AbstractSymbol(type_decl));
    }
