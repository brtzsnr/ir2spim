...
# web count: 11
# VR0-[[0, 10), [10, 15), [15, 28)]-{0}-[3, 20, 27, 26] --> $s0
# VR1-[[2, 4)]-{1}-[3] --> $s1
# VR1-[[4, 6)]-{2}-[5] --> $s1
# VR1-[[7, 10), [10, 15), [15, 17)]-{3}-[16, 9, 15] --> $s1
# VR1-[[19, 21)]-{8}-[20] --> $s1
# VR1-[[21, 23)]-{9}-[22] --> $s1
# VR1-[[24, 27)]-{10}-[26] --> $s1
# VR2-[[10, 12)]-{4}-[11] --> $s2
...
# web count: 20
# VR0-[[0, 5), [5, 10), [10, 24)]-{0}-[2, 3, 23, 10] --> $s0
# VR1-[[1, 3)]-{1}-[2] --> $s1
# VR1-[[3, 5), [5, 10), [10, 20)]-{2}-[17, 19, 4] --> $s1
# VR1-[[22, 23)]-{11}-[] --> $s1
# VR1-[[23, 25), [25, 30), [30, 34)]-{12}-[33, 24, 31] --> $s1
# VR1-[[36, 37)]-{18}-[] --> $s0
# VR1-[[37, 39)]-{19}-[38] --> $s0
# VR2-[[5, 7)]-{3}-[6] --> $s2
# VR2-[[7, 9)]-{4}-[8] --> $s2
