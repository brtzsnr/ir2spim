...
define i32 @Main__sum(i32 %ARG, i32 %ARG0, i32 %ARG1)
{
...
;; -> dispatch: linia 6
;;generez codul pentru apelul metodei sum
...
dispatch_not_void_Main_0:
  ...
  %VR10 = load i32* %VR9
  %VR11 = inttoptr i32 %VR10 to i32 (i32, i32, i32)*
  %VR12 = call i32 (i32, i32, i32)* %VR11(i32 %ARG, i32 %VR1, i32 %VR2)
;; <- dispatch: linia 6
...
@str_const__8 = global %struct.String_protObj_t{i32 3, i32 6, %struct.String_dispTab_t* @String_dispTab, %struct.Int_protObj_t* @int_const__3, i8* getelementptr ([7 x i8]* @s8, i32 0, i32 0)}
...
@str_const__5 = global %struct.String_protObj_t{i32 3, i32 6, %struct.String_dispTab_t* @String_dispTab, %struct.Int_protObj_t* @int_const__3, i8* getelementptr ([7 x i8]* @s5, i32 0, i32 0)}
@s4 = internal constant [11 x i8] c"_prim_slot\00"
@str_const__4 = global %struct.String_protObj_t{i32 3, i32 7, %struct.String_dispTab_t* @String_dispTab, %struct.Int_protObj_t* @int_const__0, i8* getelementptr ([11 x i8]* @s4, i32 0, i32 0)}
...
@s0 = internal constant [22 x i8] c"_tests/library/sum.cl\00"
@str_const__0 = global %struct.String_protObj_t{i32 3, i32 10, %struct.String_dispTab_t* @String_dispTab, %struct.Int_protObj_t* @int_const__9, i8* getelementptr ([22 x i8]* @s0, i32 0, i32 0)}
@int_const__9 = global %struct.Int_protObj_t {i32 1, i32 4, %struct.Object_dispTab_t* @Object_dispTab, i32 21}
...
@int_const__1 = global %struct.Int_protObj_t {i32 1, i32 4, %struct.Object_dispTab_t* @Object_dispTab, i32 100}
